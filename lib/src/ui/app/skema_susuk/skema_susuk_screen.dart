...
class SkemaSusukScreen extends StatefulWidget {
  const SkemaSusukScreen({super.key});

  @override
  State<SkemaSusukScreen> createState() => _SkemaSusukScreenState();
}

class _SkemaSusukScreenState
    extends AUIManagement<SkemaSusukBloc, SkemaSusukState, SkemaSusukScreen>
  ...
  @override
  void onStart() {
    stateManagement.pushEvent(SkemaSusukInitialEvent());
    super.onStart();
  }
  ...
  @override
  Widget buildState(BuildContext context, SkemaSusukState state) {
    if (state is SkemaSusukInitialError) {
    ...
    return SScaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: switch (state) {
              SkemaSusukInitialLoaded() =>
                _buildImages(context, state.imageUrls),
              SkemaSusukInitialError() => _buildErrorState(),
  ...
  Widget _buildEmptyState() {
    return const _StateContainer(
      child: _InlineMessage(
        ...
        message: 'Skema susuk belum tersedia.',
      ),
    );
  }
  ...
  Widget _buildErrorState() {
    return const _StateContainer(
      child: _InlineMessage(
        ...
        message: 'Skema susuk belum dapat dimuat.',
      ),
    );
  }

  @override
  SkemaSusukState get initialData => SkemaSusukInitial();
}
