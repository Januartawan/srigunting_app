...
class FlowClaimSusukScreen extends StatefulWidget {
  const FlowClaimSusukScreen({super.key});

  @override
  State<FlowClaimSusukScreen> createState() => _FlowClaimSusukScreenState();
}

class _FlowClaimSusukScreenState extends AUIManagement<FlowClaimSusukBloc,
    FlowClaimSusukState, FlowClaimSusukScreen> with SingleTickerProviderStateMixin {
  ...
  @override
  void onStart() {
    stateManagement.pushEvent(FlowClaimSusukInitialEvent());
    super.onStart();
  }
  ...
  @override
  Widget buildState(BuildContext context, FlowClaimSusukState state) {
    if (state is FlowClaimSusukInitialError) {
      showToastError(context, message: state.error);
    }

    return SScaffold(
      title: 'Flow Klaim Susuk & Meal',
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: switch (state) {
              FlowClaimSusukInitialLoaded() =>
                _buildImages(context, state.imageUrls),
              FlowClaimSusukInitialError() => _buildErrorState(),
  ...
  Widget _buildEmptyState() {
    return const _StateContainer(
      child: _InlineMessage(
        ...
        message: 'Flow klaim belum tersedia.',
      ),
    );
  }
  ...
  Widget _buildErrorState() {
    return const _StateContainer(
      child: _InlineMessage(
        ...
        message: 'Flow klaim belum dapat dimuat.',
      ),
    );
  }

  @override
  FlowClaimSusukState get initialData => FlowClaimSusukInitial();
}
